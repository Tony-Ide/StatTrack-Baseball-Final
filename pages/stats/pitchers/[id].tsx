...
import PitcherDashboard from "@/components/pitcher-dashboard"
  ...
  useEffect(() => {
    ...
    async function fetchPlayerStats() {
      try {
        ...
        setPitcherInfo(pitcher)
        setPlayerData({
          name: pitcher.name,
          type: "pitchers",
          team: pitcher.team_id || "Unknown",
        ...
        // Compute all distinct auto_pitch_type values for this player using new hierarchical seasons structure
      ...
      <ThemeProvider attribute="class" defaultTheme="system" enableSystem>
        <Layout showLogout fullBleed>
          <div className="flex items-center justify-center min-h-screen">
            <div className="text-lg">Loading pitcher data...</div>
          </div>
        </Layout>
      </ThemeProvider>
    )
