...
interface InteractiveStrikeZoneProps {
...
export default function InteractiveStrikeZone({ onPitchSelect, selectedPitch, games, pitchTypes = [] }: InteractiveStrikeZoneProps) {
